...
| ----------------------- | -------- | ----- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------- |
| `@orkestrel/abort`      | `0.0.11` | L1    | `@orkestrel/contract` `^0.0.17`                                                                                                                                                                                                                                                                                            |                                                                |
...
| `@orkestrel/brief`      | `0.0.9`  | L4    | `@orkestrel/reason` `^0.0.11`, `@orkestrel/emitter` `^0.0.10`, `@orkestrel/contract` `^0.0.17`, `@orkestrel/interpret` `^0.0.14`                                                                                                                                                                                           |                                                                |
| `@orkestrel/browser`    | `0.0.17` | L3    | `@orkestrel/html` `^0.0.10`, `@orkestrel/emitter` `^0.0.10`, `@orkestrel/contract` `^0.0.17`, `@orkestrel/websocket` `^0.0.13`                                                                                                                                                                                             |                                                                |
...
| `@orkestrel/form`       | `0.0.7`  | L2    | `@orkestrel/emitter` `^0.0.10`, `@orkestrel/contract` `^0.0.17`                                                                                                                                                                                                                                                            |                                                                |
| `@orkestrel/guide`      | `0.0.20` | L3    | `@orkestrel/contract` `^0.0.17`, `@orkestrel/markdown` `^0.0.15`                                                                                                                                                                                                                                                           |                                                                |
| `@orkestrel/html`       | `0.0.10` | L1    | `@orkestrel/contract` `^0.0.17`                                                                                                                                                                                                                                                                                            |                                                                |
| `@orkestrel/indexeddb`  | `0.0.12` | L1    | `@orkestrel/contract` `^0.0.17`                                                                                                                                                                                                                                                                                            |                                                                |
| `@orkestrel/interpret`  | `0.0.14` | L3    | `@orkestrel/reason` `^0.0.11`, `@orkestrel/emitter` `^0.0.10`, `@orkestrel/contract` `^0.0.17`, `@orkestrel/template` `^0.0.8`                                                                                                                                                                                             |                                                                |
| `@orkestrel/lsp`        | `0.0.9`  | L3    | `@orkestrel/emitter` `^0.0.10`, `@orkestrel/process` `^0.0.13`, `@orkestrel/contract` `^0.0.17`                                                                                                                                                                                                                            |                                                                |
| `@orkestrel/markdown`   | `0.0.15` | L2    | `@orkestrel/html` `^0.0.10`, `@orkestrel/contract` `^0.0.17`                                                                                                                                                                                                                                                               |                                                                |
| `@orkestrel/mcp`        | `0.0.32` | L4    | `@orkestrel/sse` `^0.0.8`, `@orkestrel/tool` `^0.0.16`, `@orkestrel/codec` `^0.0.4`, `@orkestrel/emitter` `^0.0.10`, `@orkestrel/process` `^0.0.13`, `@orkestrel/contract` `^0.0.17`, `@orkestrel/websocket` `^0.0.13`                                                                                                     | `@orkestrel/router` `^0.0.15`, `@orkestrel/server` `^0.0.20`   |
| `@orkestrel/middleware` | `0.0.21` | L4    | `@orkestrel/abort` `^0.0.11`, `@orkestrel/budget` `^0.0.11`, `@orkestrel/timeout` `^0.0.11`, `@orkestrel/contract` `^0.0.17`                                                                                                                                                                                               | `@orkestrel/server` `^0.0.20`, `@orkestrel/database` `^0.0.15` |
| `@orkestrel/msg`        | `0.0.11` | L1    | `@orkestrel/contract` `^0.0.17`                                                                                                                                                                                                                                                                                            |                                                                |
...
| `@orkestrel/probe`      | `0.0.15` | L5    | `@orkestrel/lsp` `^0.0.8`, `@orkestrel/mcp` `^0.0.31`, `@orkestrel/tool` `^0.0.15`, `@orkestrel/queue` `^0.0.13`, `@orkestrel/emitter` `^0.0.10`, `@orkestrel/timeout` `^0.0.10`, `@orkestrel/contract` `^0.0.17`                                                                                                          | `oxlint` `^1.82.0`, `vitest` `^4.1.11`, `typescript` `^6.0.3`  |
...
| `@orkestrel/queue`      | `0.0.14` | L3    | `@orkestrel/abort` `^0.0.11`, `@orkestrel/contract` `^0.0.17`, `@orkestrel/database` `^0.0.15`, `@orkestrel/emitter` `^0.0.10`, `@orkestrel/timeout` `^0.0.11`                                                                                                                                                             |                                                                |
| `@orkestrel/rater`      | `0.0.15` | L3    | `@orkestrel/reason` `^0.0.11`, `@orkestrel/emitter` `^0.0.10`, `@orkestrel/contract` `^0.0.17`                                                                                                                                                                                                                             |                                                                |
...
| `@orkestrel/scaffold`   | `0.0.71` | L3    | `@orkestrel/console` `^0.0.14`, `@orkestrel/contract` `^0.0.17`, `@orkestrel/emitter` `^0.0.10`, `@orkestrel/markdown` `^0.0.15`, `@orkestrel/process` `^0.0.13`, `@orkestrel/template` `^0.0.8`                                                                                                                           |                                                                |
...
| `@orkestrel/sse`        | `0.0.8`  | L1    | `@orkestrel/contract` `^0.0.17`                                                                                                                                                                                                                                                                                            |                                                                |
...
| `@orkestrel/test`       | `0.0.15` | L1    | `@orkestrel/contract` `^0.0.17`                                                                                                                                                                                                                                                                                            | `vitest` `^4.1.11`                                             |
...
| `@orkestrel/toolbox`    | `0.0.14` | L6    | `@orkestrel/form` `^0.0.6`, `@orkestrel/tool` `^0.0.15`, `@orkestrel/agent` `^0.0.23`, `@orkestrel/server` `^0.0.19`, `@orkestrel/contract` `^0.0.17`, `@orkestrel/database` `^0.0.14`, `@orkestrel/relation` `^0.0.12`, `@orkestrel/terminal` `^0.0.15`, `@orkestrel/workflow` `^0.0.18`, `@orkestrel/workspace` `^0.0.8` |                                                                |
| `@orkestrel/websocket`  | `0.0.13` | L2    | `@orkestrel/emitter` `^0.0.10`, `@orkestrel/contract` `^0.0.17`                                                                                                                                                                                                                                                            |                                                                |
| `@orkestrel/worker`     | `0.0.13` | L4    | `@orkestrel/contract` `^0.0.17`, `@orkestrel/database` `^0.0.15`, `@orkestrel/emitter` `^0.0.10`, `@orkestrel/pool` `^0.0.12`, `@orkestrel/queue` `^0.0.14`                                                                                                                                                                |                                                                |
| `@orkestrel/workflow`   | `0.0.19` | L4    | `@orkestrel/abort` `^0.0.11`, `@orkestrel/budget` `^0.0.11`, `@orkestrel/contract` `^0.0.17`, `@orkestrel/database` `^0.0.15`, `@orkestrel/emitter` `^0.0.10`, `@orkestrel/queue` `^0.0.14`, `@orkestrel/timeout` `^0.0.11`                                                                                                |                                                                |
| `@orkestrel/workspace`  | `0.0.9`  | L3    | `@orkestrel/emitter` `^0.0.10`, `@orkestrel/contract` `^0.0.17`, `@orkestrel/database` `^0.0.15`                                                                                                                                                                                                                           |                                                                |
